...
internal static class Program
{
    public static async Task<int> Main(string[]? args = null)
    {
        ...
        var tests = new (string Name, Func<Task> Run)[]
        {
            ...
            ("authority ingress is bounded and supports competing producers", NativeAuthorityIngressTests.IngressIsAllowlistedBoundedAndSupportsCompetingProducers),
            ("producer disconnect requires per-thread authority resync", NativeAuthorityIngressTests.ProducerDisconnectRequiresPerThreadResync),
